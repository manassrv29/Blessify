  ...
  const handleToggleNotify = (id: string) => {
    setContacts(
      contacts.map((contact) =>
        contact.id === id ? { ...contact, notifyOnDistress: !contact.notifyOnDistress } : contact,
      ),
    )
  }
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    id="notify"
                    checked={newContact.notifyOnDistress}
                    onCheckedChange={(checked) => setNewContact({ ...newContact, notifyOnDistress: checked })}
                  />
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    checked={contact.notifyOnDistress}
                    onCheckedChange={() => handleToggleNotify(contact.id)}
                  />
