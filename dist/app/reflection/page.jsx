...
export default function ReflectionPage() {
    ...
    const handleResponseChange = (id, value) => {
        setResponses(Object.assign(Object.assign({}, responses), { [id]: value }));
    };
    const handleNext = () => {
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Textarea placeholder={currentPrompt.placeholder} className="min-h-[150px]" value={responses[currentPrompt.id] || ""} onChange={(e) => handleResponseChange(currentPrompt.id, e.target.value)}/>
            </div>

            {currentStep === reflectionPrompts.length - 1 && (<div className="space-y-4 border-t pt-4">
                <div className="space-y-2">
                  <Label htmlFor="reflection-title">Give your reflection a title</Label>
                  <Input id="reflection-title" placeholder="e.g., A Day of Growth" value={responses.title || ""} onChange={(e) => handleResponseChange("title", e.target.value)}/>
                </div>
              </div>)}
          </CardContent>
          <CardFooter className="flex justify-between">
            ...
            <div>
              {currentStep === reflectionPrompts.length - 1 ? (<Button onClick={handleSaveReflection}>
