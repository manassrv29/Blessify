        ...
        <div className="flex flex-col md:flex-row gap-8">
            ...
            <Tabs defaultValue="discover" onValueChange={setActiveTab} className="space-y-6">
              ...
              <TabsContent value="discover" className="space-y-6">
                ...
                <div className="space-y-4">
                  {upcomingJams.map((jam) => (<Card key={jam.id}>
                      <CardHeader>
                        <div className="flex justify-between items-start">
                          ...
                          <div className="flex gap-2">
                            {jam.tags.map((tag) => (<Badge key={tag} variant="secondary">
                                {tag}
                              </Badge>))}
                          </div>
                        </div>
                      ...
                      <CardFooter className="flex justify-between">
                        <div className="flex -space-x-2">
                          {[...Array(3)].map((_, i) => (<Avatar key={i} className="border-2 border-background w-8 h-8">
              ...
              <TabsContent value="my-jams" className="space-y-6">
                ...
                <div className="space-y-4">
                  {myJams.map((jam) => (<Card key={jam.id}>
                      <CardHeader>
                        <div className="flex justify-between items-start">
                          <div>
                            <CardTitle>{jam.title}</CardTitle>
          ...
          <div className="md:w-1/3">
            ...
            : "Track your participation and engagement"}
              ...
              <CardContent>
                {activeTab === "discover" ? (<div className="space-y-4">
              ...
              <CardFooter>
                {activeTab === "discover" ? (<Button className="w-full">
                    <Plus className="mr-2 h-4 w-4"/>
                    Create Your Own Jam
